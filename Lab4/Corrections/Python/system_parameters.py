...
class PendulumParameters(SystemParameters):
    ...
    def s_theta_ref1(self, value):
        ...
        pylog.info(
            'Changed spring 1 reference angle to {} [rad]'.format(self.parameters['s_theta_ref1']))
    ...
    def s_theta_ref2(self, value):
        ...
        pylog.info(
            'Changed spring 2 reference angle to {} [rad]'.format(self.parameters['s_theta_ref2']))
